...
mod tests {
	...
	fn generates_seal_and_does_not_double_propose() {
		...
		let b1 = OpenBlock::new(engine, Default::default(), false, false, db1, &genesis_header, last_hashes.clone(), addr1, (3141562.into(), 31415620.into()), vec![], false, &mut Vec::new().into_iter()).unwrap();
		let b1 = b1.close_and_lock().unwrap();
		let b2 = OpenBlock::new(engine, Default::default(), false, false, db2, &genesis_header, last_hashes, addr2, (3141562.into(), 31415620.into()), vec![], false, &mut Vec::new().into_iter()).unwrap();
	...
	fn seal_with_empty_steps() {
		...
		// step 3
		let mut b2 = OpenBlock::new(engine, Default::default(), false, false, db2, &genesis_header, last_hashes.clone(), addr2, (3141562.into(), 31415620.into()), vec![], false, &mut Vec::new().into_iter()).unwrap();
	...
	fn seal_empty_block_with_empty_steps() {
		...
		// step 3
		let b2 = OpenBlock::new(engine, Default::default(), false, false, db2, &genesis_header, last_hashes.clone(), addr2, (3141562.into(), 31415620.into()), vec![], false, &mut Vec::new().into_iter()).unwrap();
		let b2 = b2.close_and_lock().unwrap();
		engine.set_signer(tap.clone(), addr2, "0".into());
		...
		let b3 = OpenBlock::new(engine, Default::default(), false, false, db3, &genesis_header, last_hashes.clone(), addr1, (3141562.into(), 31415620.into()), vec![], false, &mut Vec::new().into_iter()).unwrap();
	...
	fn reward_empty_steps() {
		...
		let b2 = OpenBlock::new(engine, Default::default(), false, false, db2, &genesis_header, last_hashes.clone(), addr1, (3141562.into(), 31415620.into()), vec![], false, &mut Vec::new().into_iter()).unwrap();
