...
mod tests {
	...
	fn can_generate_seal() {
		...
		let b = OpenBlock::new(engine, Default::default(), false, storage_writer::new(Default::default()), H256::default(), db, &genesis_header, last_hashes, addr, (3141562.into(), 31415620.into()), vec![], false).unwrap();
