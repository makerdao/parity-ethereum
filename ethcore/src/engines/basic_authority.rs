...
mod tests {
	...
	fn can_generate_seal() {
		...
		let b = OpenBlock::new(engine, Default::default(), false, false, db, &genesis_header, last_hashes, addr, (3141562.into(), 31415620.into()), vec![], false, &mut Vec::new().into_iter()).unwrap();
