...
pub struct ExecutedBlock {
    ...
    pub storage_writer: Box<dyn storage_writer::StorageWriter>,
    /// Block hash.
...
impl ExecutedBlock {
	...
	pub fn new(state: State<StateDB>, last_hashes: Arc<LastHashes>, tracing: bool, storage_writer: Box<dyn storage_writer::StorageWriter>, header_hash: H256) -> ExecutedBlock {
		ExecutedBlock {
